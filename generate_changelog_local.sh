# Source: 
# https://github.com/marketplace/actions/generate-changelog-based-on-conventional-commits?version=2.0.0
# https://github.com/smichard/conventional_changelog
# https://github.com/smichard/conventional_changelog/blob/main/generate_changelog_local.sh
